...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field members on 'Institution'
        m2m_table_name = db.shorten_name(u'protocols_institution_members')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('institution', models.ForeignKey(orm[u'protocols.institution'], null=False)),
            ('user', models.ForeignKey(orm[u'members.user'], null=False))
        ))
        db.create_unique(m2m_table_name, ['institution_id', 'user_id'])


    def backwards(self, orm):
        # Removing M2M table for field members on 'Institution'
        db.delete_table(db.shorten_name(u'protocols_institution_members'))
