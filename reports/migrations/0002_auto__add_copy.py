...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Copy'
        db.create_table(u'reports_copy', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('report', self.gf('django.db.models.fields.related.ForeignKey')(related_name='copies', to=orm['reports.Report'])),
            ('topic', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['protocols.Topic'])),
        ))
        db.send_create_signal(u'reports', ['Copy'])
    ...
    def backwards(self, orm):
        # Deleting model 'Copy'
        db.delete_table(u'reports_copy')
    ...
    models = {
        ...
        u'reports.copy': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'report': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'copies'", 'to': u"orm['reports.Report']"}),
            'topic': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['protocols.Topic']"})
        },
        u'reports.report': {
