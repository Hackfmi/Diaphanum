...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Report.signed_from'
        db.add_column(u'reports_report', 'signed_from',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Report.signed_from'
        db.delete_column(u'reports_report', 'signed_from')
