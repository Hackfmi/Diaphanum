...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Project.partners'
        db.alter_column(u'projects_project', 'partners', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'Project.partners'
        db.alter_column(u'projects_project', 'partners', self.gf('django.db.models.fields.TextField')(default=' '))
