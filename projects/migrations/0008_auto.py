...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field participating on 'Project'
        m2m_table_name = db.shorten_name(u'projects_project_participating')
    ...
    def backwards(self, orm):
        # Removing M2M table for field participating on 'Project'
        db.delete_table(db.shorten_name(u'projects_project_participating'))
    ...
    models = {
        ...
        u'projects.project': {
            ...
            'attitute': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'created_at': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 9, 29, 0, 0)'}),
            ...
            'participating': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'participants'", 'blank': 'True', 'to': u"orm['members.User']"}),
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'projects'", 'to': u"orm['members.User']"})
        }
    }
