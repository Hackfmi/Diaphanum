...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.attitute'
        db.add_column(u'projects_project', 'attitute',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Project.number'
        db.add_column(u'projects_project', 'number',
                      self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.attitute'
        db.delete_column(u'projects_project', 'attitute')

        # Deleting field 'Project.number'
        db.delete_column(u'projects_project', 'number')
